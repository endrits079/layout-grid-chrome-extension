# Grid Overlay Tool Chrome Extension
...
2. Search for "Grid Overlay Tool" 
...
5. The Grid Overlay Tool icon will appear in your toolbar

## Usage

1. Click the Grid Overlay Tool icon in your toolbar
2. Choose your preferred grid type (Spacing Grid is default)
3. Adjust spacing, color, and opacity as needed
4. Click "Apply Settings" to update the grid
5. Click "Toggle Grid" to show/hide the overlay
